    ...
    return (
        ...
        >
            <motion.svg
                ...
                animate={{
                    rotate: [0, 0, 45, 1125, 1080, 1080] // Rest -> Start -> Accelerate -> Spin (3 turns) -> Decelerate -> Rest
                }}
                transition={{
                    duration: 5,
                    times: [0, 0.2, 0.3, 0.7, 0.9, 1], // Timing of each stage
                    ease: "easeInOut",
                    repeat: Infinity,
                    repeatDelay: 1
                }}
            >
                ...
                <line x1="20" y1="80" x2="80" y2="20" stroke="currentColor" strokeWidth="6" />
            </motion.svg>
        </motion.span>
    );
}
