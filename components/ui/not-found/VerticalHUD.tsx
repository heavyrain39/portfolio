...
export default function VerticalHUD({ side }: VerticalHUDProps) {
    ...
    return (
        <div
            className={`flex items-center gap-1 md:gap-0 h-full z-20 ${isLeft ? 'flex-row' : 'flex-row-reverse'}`}
            style={{
        ...
        >
            ...
            <div
                className={`text-[var(--foreground)] opacity-80 shrink-0 ${isLeft ? 'md:translate-x-3' : 'md:-translate-x-3'}`}
