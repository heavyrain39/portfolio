    ...
    return (
        <section id="about" className="container mx-auto px-6 py-32 grid grid-cols-1 md:grid-cols-12 gap-12">
            ...
            <div className="md:col-span-4">
                ...
                <div className="w-12 h-1 bg-current mb-6 opacity-100" />
                <p className="font-mono text-sm opacity-40">
                    ID: YAKSHAWAN = Arm of Yaksha<br />
            ...
            <div className="md:col-span-8 flex flex-col gap-8 text-lg opacity-100 leading-relaxed text-justify break-keep">
                ...
                <div className="pt-2 mt-4">
                    <h4 className="font-mono text-sm uppercase mb-3 opacity-60">{isMounted ? t.highlightsTitle : dictionary.ko.about.highlightsTitle}</h4>
                    <ul className="space-y-2 list-disc pl-5 marker:text-current/60 font-sans text-base">
